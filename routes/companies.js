 ...
 */
  router.get("/", async function (req, res, next) {
    try {
        ...
        // Convert minEmployees and maxEmployees to numbers
        ...
        if (minEmployees) {
            filterCriteria.minEmployees = minEmployees;
        }
        if (maxEmployees) {
            filterCriteria.maxEmployees = maxEmployees;
        }

        // Call the getFilteredCompanies function from the Company class
        const companies = await Company.getFilteredCompanies(filterCriteria);
